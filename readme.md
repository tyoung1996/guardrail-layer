...
- 🔒 **Automatic Redaction** — mask emails, IDs, or sensitive values at query time  
- 🌐 **Global Regex Redactions** — define patterns (emails, SSNs, credit cards) that apply across all tables  
- 🧩 **Role-Aware Redactions** *(coming soon)* — conditionally hide or show fields by user role  
- 🧠 **Schema Awareness** — AI-ready metadata for safer, context-aware queries  
- 💬 **Natural-Language Queries** — ask things like *“Who are our top customers by revenue?”*  
- ⚙️ **Connection Validation** — test Postgres/MySQL access with instant feedback  
- 🧱 **Extensible Architecture** — Node.js, Prisma, and Postgres foundation for easy expansion  
- 🧪 **One-Click Demo Database** — spin up sample data instantly for safe experimentation  
- 📜 **Audit Logging** — every query, redaction, and connection event is transparently logged  
- 🧰 **Modern UI** — manage connections, regex patterns, and privacy settings visually  
